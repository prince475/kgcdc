  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="  text-left">
        <DynamicText as="p" className="text-sm text-left lg:text-base text-gray-700">
          {staffIntro[0].description} 
        </DynamicText>
      </div>

      {/* First card takes full width */}
       <div className="flex border border-gray-500 flex-col lg:flex-row gap-8 p-4">
         ...
         <div className="lg:w-1/2 mt-10 lg:mt-10 ">
           ...
           <div className="flex flex-col  gap-4">
              <p className="lg:text-[16px]leading-normal text-black text-left mt-4">
              ...
              <p className="lg:text-lg leading-normal  text-left mt-4">
